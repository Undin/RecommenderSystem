 ...
 */
class MultilayerPerceptron extends AbstractClassifier implements
    ...
    public double weightSum() {
        return Arrays.stream(m_neuralNodes)
                .mapToDouble(n -> DoubleStream.of(((NeuralNode) n).getWeights()).sum())
                .sum();
    }
}
